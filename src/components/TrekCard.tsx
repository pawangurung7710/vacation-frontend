        ...
        >
            ...
            <div className="p-6 flex flex-col flex-1">
                ...
                <div className="pt-4 border-t border-border-subtle flex items-center justify-between">
                    ...
                    <button className="flex items-center justify-center space-x-2 px-4 py-2 bg-transparent border border-cta-accent text-cta-accent rounded-xl font-bold hover:bg-cta-accent hover:text-white transition-all group-hover:shadow-md text-sm">
                        <span>Details</span>
